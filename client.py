...
while True:
    ...
    if comanda == 'EXIT':
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat inainte sa folosesti PUBLISH.")
            continue
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat inainte sa folosesti DELETE.")
            continue

        if len(parti) < 2 or not parti[1].strip():
            print("EROARE: Trebuie sa furnizezi un ID pentru DELETE.")
            continue
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat inainte sa folosesti LIST.")
            continue
